                ...
                <div class="text-inter text-center pl-36 font-light" id="nav-bar-container-elem">
                    <ul class="md:flex md:items-center gap-[22px] md:justify-center">
                        ...
                        <li id="nav-bar-kit" class="text-white text-center items-center text-[24px] w-[180px] h-[40px] hover:bg-[#BFA07A] bg-[length:180px_40px] rounded-[10px]">
                            <a href="Konstruktor" style = "text-center">Конструктор</a>
                        </li>
                        <li id="nav-bar-contact" class="text-white text-center text-[24px] w-[180px] h-[40px] hover:bg-[#BFA07A] bg-[length:180px_40px] rounded-[10px]">
                            <a href="Contact" style = "text-center">Контакты</a>
                        </li>
                        <div class = "text-center gap-y-[15px] grid items-end">   
                            <div class="text-center" id="button_entry">
                                <a href="Login"><button id="nav-bar-but2" class="bg-[#A69286] text-white px-5 py-2 rounded-full text-[20px] hover:bg-[#261201]">Войти</button></a>
                            </div>
                            <div class="text-center" id="button_entry1">
                                <a href="Register"><button id="nav-bar-but2" class="bg-[#A69286] text-white px-5 py-2 rounded-full text-[20px] hover:bg-[#261201]">Зарегистрироваться</button></a>
                            </div>
                        </div>
                    </ul>
                </div>
...
fn Konstruktor() -> impl IntoView {
    ...
    view! {
        ...
        <div id="main_body">
            <div id="left_side" class="md:flex md:items-center w-1/2">
                <section id="search" class="w-full h-[73px] bg-[#EEEEEE]">
                    <div class="justify-between h-[37px] mt-[18px] mb-[18px] ml-[25px] mr-[25px] relative">
                        <input type="search" class="w-full h-full outline-none bg-[#261201] bg-opacity-[81%] border-solid border-[3px] rounded-[10px] border-[#8C7456] placeholder-[#A1A1A1] text-[16px] font-light pl" name="search-text" placeholder="Поиск документов"/>
            ...
            <div id="balka_ebanay" class="w-[14px] h-full bg-[#8C7456]">
            </div>
            <div id="right_side">
            </div>
        </div>
        ...
        <div id="wrapper" class="md:flex md:justify-center md:items-center min-h-screen bg-[#8C7456]">
            <form action="" class="w-[420px] bg-transparent border-solid border-2 border-[#ffffff33] backdrop-blur-[20px] text-[#EEEEEE] rounded-[10px] pt-[30px] pb-[30px] pl-[40px] pr-[40px]">
                ...
                <div  class="w-full h-[50px] mt-[30px] mb-0 relative">
                    <input id="input-box" class="w-full h-full bg-transparent outline-none border-solid border-2 border-[#ffffff33] rounded-[40px] placeholder-[#EEEEEE] text-[18px] pb-[20px] pr-[45px] pt-[20px] pl-[20px] " type="password" placeholder="Пароль" required></input>
                ...
                <div id="remember-forgot" class="md:flex justify-between text-[15px] mt-[15px] mb-[15px] mr-0 ml-0 ">
                    <label class="accent-[#EEEEEE]">
                        <input type="checkbox" class="mr-[3px] ml-[1px]"></input>
                        Запомнить пароль
                    </label>
                    <a href="#" class="hover:underline">Забыли пароль?</a>
                </div>
                <button id="but_login" class="w-full h-[45px] bg-[#EEEEEE] border-none rounded-[40px] outline-none shadow-[0_0_10px_rgba(0,0,0,0.1) text-[16px] text-[#333] font-bold" type="submit">Login</button>
                <div id="Register_link" class="text-[15px] text-center mt-[15px]">
                    <p><a href="Register" class="font-semibold hover:underline">Создать аккаунт</a></p>
                </div>
            </form>
        </div>
    }
...
fn Register() -> impl IntoView {
    ...
    view! {
        ...
        <form action="" class="w-[420px] bg-transparent border-solid border-2 border-[#ffffff33] backdrop-blur-[20px] text-[#EEEEEE] rounded-[10px] pt-[30px] pb-[30px] pl-[40px] pr-[40px]">
            ...
            <div  class="w-full h-[50px] mt-[30px] mb-0 relative">
                <input id="input-box" class="w-full h-full bg-transparent outline-none border-solid border-2 border-[#ffffff33] rounded-[40px] placeholder-[#EEEEEE] text-[18px] pb-[20px] pr-[45px] pt-[20px] pl-[20px]" type="text" placeholder="Имя" required></input>
                <i class="bx bx-user absolute right-[20px] text-[20px] top-[50%] -translate-y-1/2"></i>
            </div>
            <div  class="w-full h-[50px] mt-[30px] mb-0 relative">
                <input id="input-box" class="w-full h-full bg-transparent outline-none border-solid border-2 border-[#ffffff33] rounded-[40px] placeholder-[#EEEEEE] text-[18px] pb-[20px] pr-[45px] pt-[20px] pl-[20px]" type="text" placeholder="Фамилия" required></input>
                <i class="bx bx-user absolute right-[20px] text-[20px] top-[50%] -translate-y-1/2"></i>
            </div>
            <div  class="w-full h-[50px] mt-[30px] mb-0 relative">
                <input id="input-box" class="w-full h-full bg-transparent outline-none border-solid border-2 border-[#ffffff33] rounded-[40px] placeholder-[#EEEEEE] text-[18px] pb-[20px] pr-[45px] pt-[20px] pl-[20px]" type="text" placeholder="Логин" required></input>
            ...
            <div  class="w-full h-[50px] mt-[30px] mb-0 relative">
                <input id="input-box" class="w-full h-full bg-transparent outline-none border-solid border-2 border-[#ffffff33] rounded-[40px] placeholder-[#EEEEEE] text-[18px] pb-[20px] pr-[45px] pt-[20px] pl-[20px]" type="email" placeholder="E-mail" required></input>
                <i class="bx bx-user absolute right-[20px] text-[20px] top-[50%] -translate-y-1/2"></i>
            </div>
            <div  class="w-full h-[50px] mt-[30px] mb-0 relative">
                <input id="input-box" class="w-full h-full bg-transparent outline-none border-solid border-2 border-[#ffffff33] rounded-[40px] placeholder-[#EEEEEE] text-[18px] pb-[20px] pr-[45px] pt-[20px] pl-[20px] " type="password" placeholder="Пароль" required></input>
            ...
            <button id="but_login" class="w-full h-[45px] bg-[#EEEEEE] border-none rounded-[40px] outline-none shadow-[0_0_10px_rgba(0,0,0,0.1) text-[16px] text-[#333] font-bold" type="submit">Login</button>
            <div id="Register_link" class="text-[15px] text-center mt-[15px]">
                <p>Есть аккаунт?<a href="Login" class="font-semibold hover:underline ml-[5px]">Войти</a></p>
            </div>
        </form>
    </div>
    }
