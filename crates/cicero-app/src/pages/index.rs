                ...
                <section class="flex flex-col flex-1 items-center pt-[40px] bg-[#eeeeee]">
                    <div class="text-center px-3 lg:px-0">
                        <h1 class="my-4 text-[40px] px-[150px] text-[#8C7456] leading-tight w-[1/2]">
                            "Проект \"Cicero\" — это удобный инструмент для создания юридически значимых документов"
                        </h1>
                        <p class="leading-normal text-[26px]  px-[400px] text-[#8C7456] mb-8">
                        ...
                        <a href="/scenario" class="w-[800px] ">
                            <button class="mx-auto  rounded-[6px] lg:mx-0 hover:underline bg-[#8c7456] text-[#ebe8e8] text-[25px] font-extrabold my-2 md:my-6 py-4 px-6 shadow-2xl w-[800px] h-[110px]">
