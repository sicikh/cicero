...
pub fn RightSide() -> impl IntoView {
    view! {
        <div id="right_side" class="md:flex flex-col md:items-center border-l-[7px] border-[#8C7456] w-1/2 basis-1/2">
            ...
            <section id="choice_description_or_change" class="flex flex-row w-full h-[40px] relative bg-[#EEEEEE]">
